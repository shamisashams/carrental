                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mg-t-40">
                        <table class="table table-invoice table-bordered">
                            <thead>
                            <tr>
                                <th class="wd-20p">car</th>

                                <th class="tx-center">pickup location, date</th>
                                <th class="tx-center">drop-off location, date</th>
                                <th class="tx-right">period days</th>
                            ...
                            <tr>
                                ...
                                <td class="tx-center">{{$order->pickup_loc}}, {{$order->pickup_date}}</td>
                                <td class="tx-center">{{$order->dropoff_loc}}, {{$order->dropoff_date}}</td>
                                <td class="tx-right">{{$order->period}}days</td>
                                <td class="tx-right">{{$order->car_price}}₾ per day</td>
                            </tr>
