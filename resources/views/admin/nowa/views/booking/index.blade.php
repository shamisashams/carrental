...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">@lang('admin.booking')</span>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">@lang('admin.booking')</h4>
                    </div>
                                ...
                                @if($orders)
                                    @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{locale_route('booking.edit',$order->id)}}"
                                                   class="pl-3">
                                                    <i class="fa fa-edit">რედაქტირება</i>
                                                </a>

                                                <a href="{{locale_route('booking.show',$order->id)}}"
                                                   class="pl-3">
