...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">{{$model->created_at ? __('admin.extra_option-update') : __('admin.extra_option-create')}}</span>
        </div>
                                        ...
                                        <div class="tab-pane {{$active}}" id="lang-{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control"
                                                          name="{{$locale}}[text]">{!! $model->translate($locale)->text ?? old('text') !!}</textarea>
                                                @error($locale.'.text')
                                            ...
                                            {{--<div class="form-group">
                                                ...
                                                <textarea class="form-control"
                                                          name="{{$locale}}[answer]">{!! $model->translate($locale)->answer ?? '' !!}</textarea>
                                                @error($locale.'.answer')
                                                <small class="text-danger">
                                                    <div class="error">
                                                        {{$message}}
