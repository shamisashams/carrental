...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">{{$blog->created_at ? __('admin.news-update') : __('admin.news-create')}}</span>
        </div>
                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        ...
                                        <div class="tab-pane {{$active}}" id="lang-{{$locale}}">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{$locale.'[title]'}}" class="form-control" placeholder="Name" value="{{$blog->translate($locale)->title ?? old($locale.'.title')}}">
                                                @error($locale.'.title')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="{{$locale.'[short_description]'}}" class="form-control">{{$blog->translate($locale)->short_description ?? old($locale.'.short_description')}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="text_top-{{$locale}}" class="form-control"
                                                          name="{{$locale}}[description]">{!! $blog->translate($locale)->description ?? old($locale.'.description') !!}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::text($locale.'[meta_title]',$blog->translate($locale)->meta_title ?? old($locale.'.meta_title'),['class' => 'form-control']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::text($locale.'[meta_description]',$blog->translate($locale)->meta_description ?? old($locale.'.meta_description'),['class' => 'form-control']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::text($locale.'[meta_keyword]',$blog->translate($locale)->meta_keyword ?? old($locale.'.meta_keyword'),['class' => 'form-control']) !!}
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @foreach($categories as $category)
                        <div class="form-group">
                            <label class="ckbox"><input name="categories[]" value="{{$category->id}}" type="checkbox" {{in_array($category->id,$ids)?'checked':''}}><span>{{$category->title}}</span></label>
                        </div>
                    @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" class="form-control" placeholder="@lang('admin.slug')" value="{{$blog->slug ?? old('slug')}}">
                        @error('slug')
                        <small class="text-danger">
                            <div class="error">
                                {{$message}}
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <h6 class="card-title mb-1">@lang('admin.news_images')</h6>
                    </div>
