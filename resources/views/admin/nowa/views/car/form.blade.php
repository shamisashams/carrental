...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">{{$model->created_at ? __('admin.car-update') : __('admin.car-create')}}</span>
        </div>
                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        ...
                                        <div class="tab-pane {{$active}}" id="lang-{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="{{$locale.'[short_description]'}}" class="form-control">{{$model->translate($locale)->short_description ?? old($locale.'.short_description')}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="text_top-{{$locale}}" class="form-control"
                                                          name="{{$locale}}[text]">{!! $model->translate($locale)->text ?? old($locale.'.text') !!}</textarea>
                                                @error($locale.'.text')
                                                <small class="text-danger">
                                                    <div class="error">
                                                        {{$message}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::text($locale.'[meta_title]',$model->translate($locale)->meta_title ?? old($locale.'.meta_title'),['class' => 'form-control']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::text($locale.'[meta_description]',$model->translate($locale)->meta_description ?? old($locale.'.meta_description'),['class' => 'form-control']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::text($locale.'[meta_keyword]',$model->translate($locale)->meta_keyword ?? old($locale.'.meta_keyword'),['class' => 'form-control']) !!}
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="brand_id">
                            ...
                            @foreach($brands as $brand)
                                <option value="{{$brand->id}}" {{$model->brand_id == $brand->id?'selected':''}}>{{$brand->title}}</option>
                            @endforeach
                        </select>
                        @error('brand_id')
                        <small class="text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="car_type_id">
                            ...
                            @foreach($types as $type)
                                <option value="{{$type->id}}" {{$model->car_type_id == $type->id?'selected':''}}>{{$type->title}}</option>
                            @endforeach
                        </select>
                        @error('car_type_id')
                        <small class="text-danger">
                    ...
                    <div class="form-group">
                        {!! Form::label('model',__('admin.model'),['class' => 'form-label']) !!}
                        <input type="text" name="model" class="form-control" placeholder="@lang('admin.model')" value="{{$model->model ?? old('model')}}">
                        @error('model')
                        <small class="text-danger">
                            <div class="error">
                                {{$message}}
