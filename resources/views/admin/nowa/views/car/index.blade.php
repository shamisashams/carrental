            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">@lang('admin.cars')</h4>
                    </div>
                    <a href="{{locale_route('car.create')}}" class="btn ripple btn-primary" type="button">@lang('admin.createbutt')</a>
                                    ...
                                    @foreach($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{locale_route('car.edit',$item->id)}}"
                                                   class="pl-3">
                                                    <i class="fa fa-edit">შეცვლა</i>
                                                </a>
                                                <a href="{{locale_route('car.destroy',$item->id)}}"
