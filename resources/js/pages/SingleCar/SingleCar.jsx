    ...
    useEffect(() => {
        if (values.pickup_date && values.dropoff_date) {
            ...
            checked.forEach((item, index) => {
                c_price +=
                    parseInt(item.dataset.per_day) === 1
                        ? parseFloat(item.value) * Difference_In_Days
            ...
            <div className="wrapper singleCar">
                <div className="flex car_info">
                    <div className="gray_box">
                        <h3>
                            {car.brand ? car.brand.title : ""} {car.model}{" "}
                            {/*2019*/}
                        </h3>
                        <div className="flex">
                            <div className="img">
                                <img
                                    src={
                                        car.latest_image
                                            ? car.latest_image.file_full_url
                                            : null
                                    }
                                    alt=""
                                />
                    ...
                    <div className="right">
                        ...
                        <strong>
                            {__("client.car_extra_options", localizations)}
                        </strong>
                            ...
                            return (
                                <div className="flex check">
                                    <input
                                        ...
                                        type="checkbox"
                                        name="extra"
                                        data-per_day={item.price_per_day}
                                        data-id={item.id}
                                        id={`option_${index}`}
                                        value={item.price}
                                    />
                ...
                <h6 style={{ fontSize: "16px" }}>
                    {__("client.car_u_may_like", localizations)}
                </h6>
                <CarSlider cars={cars} />
            </div>
        </Layout>
