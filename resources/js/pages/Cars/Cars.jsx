...
const Cars = ({ seo }) => {
    ...
    if (appliedFilters.hasOwnProperty("air_conditioning")) {
        if (appliedFilters["air_conditioning"].includes((1).toString())) {
            aic_checked = true;
                ...
                <div className="wrapper flex">
                    ...
                    >
                        ...
                        <div className="gray_box">
                            ...
                            {seats.map((item, index) => {
                                ...
                                return (
                                    <div key={index} className="flex">
                                        <label
                                            htmlFor={`carFeature5_${item.seat}`}
                                        >
                                            Seats - {item.seat}
                                        </label>
                                        <input
                            ...
                            {doors.map((item, index) => {
                                ...
                                return (
                                    <div key={index} className="flex">
                                        <label
                                            htmlFor={`carFeature6_${item.door}`}
                                        >
                                            Doors - {item.door}
                                        </label>
                                        <input
                        ...
                        <button onClick={search} className="main-btn">
                            {__("client.filter_search", localizations)}
                        </button>
                    </section>
                    <section className="section carsTabs ">
                        <div style={{ marginBottom: "30px" }}>
                            {cars.data.map((item, index) => {
                                console.log("this is car item", item);
                                return (
                                    <CarBox
                                        key={index}
                                        model={`${
                      ...
                      <button>
                          <CgChevronRight />
                            ...
                            {linksPrev(cars.links)}
                            {links(cars.links)}
                            {linksNext(cars.links)}
                        </div>
                    </section>
                </div>
            </div>
