...
class BrandController extends Controller
{
    ...
    public function index(ProductRequest $request)
    {
        ...
        return view('admin.nowa.views.brand.index', [
            'data' => $this->brandRepository->getData($request, ['translations'])
        ]);
    }
    ...
    {
        $blog = $this->brandRepository->model;
        ...
        return view('admin.nowa.views.brand.form', [
            'model' => $blog,
            'url' => $url,
            'method' => $method,
    ...
    public function store(Request $request)
    {
        ...
        $news = $this->brandRepository->create($saveData);

        // Save Files
        if ($request->hasFile('images')) {
            $news = $this->brandRepository->saveFiles($news->id, $request);
        }
        ...
        return redirect(locale_route('brand.index', $news->id))->with('success', __('admin.create_successfully'));
     ...
     * @throws ReflectionException
     */
    public function update(Request $request, string $locale, Brand $brand)
    {
        $request->validate([
            config('translatable.fallback_locale') . '.title' => 'required',
        ]);
        ...
        $this->brandRepository->update($brand->id, $saveData);
